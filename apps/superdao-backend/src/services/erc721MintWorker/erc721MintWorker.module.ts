...
import { Erc721MintWorkerService } from './erc721MintWorker.service';
import { Erc721MintWorkerHelper } from './erc721MintWorker.helper';
import { HealthCheckModule } from '../healthCheck/healthCheck.module';
import { EthersModule } from '../ethers/ethers.module';

const DOMAIN_MODULES = [TracerModule, UserModule, EmailModule, BabyRobotModule, CacheModule];

@Module({
	providers: [Erc721MintWorkerService, Erc721MintWorkerHelper],
	imports: [
...
export class Erc721MintWorkerModule {}
