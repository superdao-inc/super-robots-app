...
import { RobotImageGenerationWorkerService } from './robotImageGenerationWorker.service';
...
@Module({
	providers: [RobotImageGenerationWorkerService, RobotImageGenerationWorkerHelper],
	imports: [
...
export class RobotImageGenerationWorkerModule {}
