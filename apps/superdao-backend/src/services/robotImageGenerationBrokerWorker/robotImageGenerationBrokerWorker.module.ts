...
import { RobotImageGenerationBrokerWorkerController } from './robotImageGenerationBrokerWorker.controller';
...
@Module({
	controllers: [RobotImageGenerationBrokerWorkerController],
	providers: [RobotImageGenerationBrokerWorkerService],
	imports: [
...
export class RobotImageGenerationBrokerWorkerModule {}
